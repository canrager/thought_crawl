...
CUDA_VISIBLE_DEVICES=0,1,2 nohup python exp/run_crawler.py \
    --device "cuda" \
    --cache_dir "/disk/u/models/" \
    --model_path "meta-llama/Llama-3.3-70B-Instruct" \
    --quantization_bits 8 \
    --prompt_injection_location "assistant_prefix" \
    --load_fname "crawler_log_20250328_012521_Llama-3.3-70B-Instruct_1samples_100000crawls_Truefilter_assistant_prefixprompt_q8.json" \
    "$@" \
    > "$LOG_FILE" 2>&1 &
